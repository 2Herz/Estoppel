...
void SettingMenuUI::Init(HWND _hWnd)
{
	IMG_MGR->OpenImg("Image/SettingMenu.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuSBOX.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuBlack.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuBlack0.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuBlack1.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuBlack2.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuBlack3.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuBlack4.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuBlack5.bmp");
	IMG_MGR->OpenImg("Image/SettingMenuBlack6.bmp");
}

void SettingMenuUI::Click_Button(int _key)
{
	if (VK_LEFT == _key)
	{
...
void SettingMenuUI::MenuDisplay(HDC _hdc)
{
